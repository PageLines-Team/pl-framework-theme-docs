  ...
  function export_template(){
    ...
    $btns = sprintf(
      '<div class="checklist-btns">
        <button class="btn btn-default btn-xs checklist-tool" data-action="checkall"><i class="icon icon-ok"></i> %s</button> 
        <button class="btn btn-default btn-xs checklist-tool" data-action="uncheckall"><i class="icon icon-remove"></i> %s</button>
